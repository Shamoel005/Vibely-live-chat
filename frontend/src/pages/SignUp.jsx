...
//         <input type="text" placeholder='username' className='w-[90%] h-[50px] outline-none border-2 border-[#663399] px-[20px] py-[10px] bg-[white] rounded-lg shadow-gray-200 shadow-lg text-gray-700 text-[19px]' onChange={(e)=>setUserName(e.target.value)} value={userName}/>
...
//         <button className='px-[20px] py-[10px] bg-[#663399] rounded-2xl shadow-gray-400 shadow-lg text-[20px] w-[200px] mt-[20px] font-semibold hover:shadow-inner' disabled={loading}>{loading?"Loading...":"Sign Up"}</button>
//         <p className='cursor-pointer' onClick={()=>navigate("/login")}>Already Have An Account ? <span className='text-[#663399] text-[bold]' >Login</span></p>
//      </form>
//      </div>
        ...
        <div className='min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 flex items-center justify-center p-4'>
            <div className='w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden transition-all duration-300 hover:shadow-3xl'>
                ...
                <div className='bg-gradient-to-r from-purple-600 to-indigo-600 py-12 px-6 text-center'>
                    ...
                    <h1 className='text-3xl font-bold text-white mb-2'>Join Vibely</h1>
                    <p className='text-purple-100'>Create your account and start chatting</p>
                </div>
